    ...
    public class AssessmentControllerTests
    {
        ...
        public async Task CreateAsync_ReturnsBadRequest_WhenRequestPayloadIsNull()
        {
            _resourceServiceMock
                .Setup(r => r.GetString(SD.BAD_REQUEST_MESSAGE, SD.ASSESSMENT_QUESTION))
                .Returns(string.Concat(SD.ASSESSMENT_QUESTION, " không hợp lệ"));
            ...
            apiResponse
                ...
                .Equals($"{SD.ASSESSMENT_QUESTION} không hợp lệ");
        }
        ...
        public async Task CreateAsync_ReturnsBadRequest_WhenQuestionAlreadyExists()
        {
            ...
            _assessmentQuestionRepositoryMock
                .Setup(r =>
                    r.GetAsync(
                        It.IsAny<Expression<Func<AssessmentQuestion, bool>>>(),
                        It.IsAny<bool>(),
                        It.IsAny<string>(),
                        It.IsAny<string>()
                    )
            ...
            apiResponse
                .ErrorMessages.FirstOrDefault()
                .Should()
                .Be($"{existingQuestion.Question} đã tồn tại");
        }
        ...
        public async Task CreateAsync_ReturnsUnauthorized_WhenUserIsUnauthorized()
        {
            ...
            var requestPayload = new AssessmentQuestionCreateDTO { Question = "Sample Question" };
            ...
            var assessmentQuestions = new List<AssessmentQuestion>
            {
                new AssessmentQuestion
                {
                    ...
                    AssessmentOptions = new List<AssessmentOption>()
                    {
                        ...
                        {
                            Id = 1,
                            OptionText = "Option 1 Question 1",
                            Point = 3,
                            QuestionId = 1,
                        },
                        new AssessmentOption()
                        {
                            Id = 2,
                            OptionText = "Option 2 Question 1",
                            Point = 4,
                            QuestionId = 1,
                        },
                        new AssessmentOption()
                        {
                            Id = 3,
                            OptionText = "Option 3 Question 1",
                            Point = 5,
                            QuestionId = 1,
                        },
                        new AssessmentOption()
                        {
                            Id = 4,
                            OptionText = "Option 4 Question 1",
                            Point = 6,
                            QuestionId = 1,
                        },
                    },
                ...
                new AssessmentQuestion
                {
                    ...
                    AssessmentOptions = new List<AssessmentOption>()
                    {
                        ...
                        {
                            Id = 5,
                            OptionText = "Option 1 Question 2",
                            Point = 3,
                            QuestionId = 2,
                        },
                        new AssessmentOption()
                        {
                            Id = 6,
                            OptionText = "Option 2 Question 2",
                            Point = 4,
                            QuestionId = 2,
                        },
                        new AssessmentOption()
                        {
                            Id = 7,
                            OptionText = "Option 3 Question 2",
                            Point = 5,
                            QuestionId = 2,
                        },
                        new AssessmentOption()
                        {
                            Id = 8,
                            OptionText = "Option 4 Question 2",
                            Point = 6,
                            QuestionId = 2,
                        },
                    },
            ...
            _assessmentQuestionRepositoryMock
                .Setup(r =>
                    r.GetAllNotPagingAsync(
                        ...
                        It.IsAny<string>(),
                        It.IsAny<string>(),
                        It.IsAny<Expression<Func<AssessmentQuestion, object>>>(),
                        It.IsAny<bool>()
                    )
                )
