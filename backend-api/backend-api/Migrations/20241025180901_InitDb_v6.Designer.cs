...
namespace backend_api.Migrations
{
    ...
    [Migration("20241025180901_InitDb_v6")]
    partial class InitDb_v6
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend_api.Models.ExerciseTypeExercise", b =>
                {
                    b.Property<int>("ExerciseTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ExerciseTypeId", "ExerciseId");

                    b.HasIndex("ExerciseId");

                    b.ToTable("ExerciseTypeExercises");
                });
            ...
            modelBuilder.Entity("backend_api.Models.SyllabusExercise", b =>
                {
                    ...
                    b.ToTable("SyllabusExercise");
                });

            modelBuilder.Entity("backend_api.Models.SyllabusExerciseType", b =>
                {
                    b.Property<int>("SyllabusId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SyllabusId", "ExerciseTypeId");

                    b.HasIndex("ExerciseTypeId");

                    b.ToTable("SyllabusExerciseTypes");
                });
            ...
            modelBuilder.Entity("backend_api.Models.ExerciseTypeExercise", b =>
                {
                    b.HasOne("backend_api.Models.Exercise", "Exercise")
                        .WithMany("ExerciseTypeExercises")
            ...
            modelBuilder.Entity("backend_api.Models.SyllabusExerciseType", b =>
                {
                    b.HasOne("backend_api.Models.ExerciseType", "ExerciseType")
                        .WithMany("SyllabusExerciseTypes")
                        .HasForeignKey("ExerciseTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("backend_api.Models.Exercise", b =>
                {
                    b.Navigation("ExerciseTypeExercises");
            ...
            modelBuilder.Entity("backend_api.Models.ExerciseType", b =>
                {
                    ...
                    b.Navigation("SyllabusExerciseTypes");
            ...
            modelBuilder.Entity("backend_api.Models.StudentProfile", b =>
                {
                    b.Navigation("InitialAssessmentResults");
