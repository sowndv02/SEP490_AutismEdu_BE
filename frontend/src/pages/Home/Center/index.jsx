...
import { Box, Button, Card, CardActions, CardContent, CardMedia, Grid, IconButton, Rating, Stack, Typography } from '@mui/material';
import ButtonIcon from '~/components/ButtonComponent/ButtonIcon';
import ChipComponent from '~/components/ChipComponent';
function Center() {
    return (
        <Stack sx={{ mt: "100px", justifyContent: "center", bgcolor: "#f9f9ff", py: "100px" }} direction='row'>
            <Box sx={{
                width: {
                    xl: "80%",
                    lg: "90%"
