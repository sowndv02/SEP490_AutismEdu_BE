...
import { Box, Checkbox, Divider, FormControl, FormControlLabel, FormGroup, FormHelperText, IconButton, InputAdornment, InputLabel, OutlinedInput, SvgIcon, TextField } from '@mui/material';
                ...
                <CardContent>
                    ...
                    <Box mt="30px">
                        <FormControl sx={{ ...INPUT_CSS }} variant="outlined">
                            ...
                            <OutlinedInput id="username" label="Username" variant="outlined" type='text'
                    ...
                    <Button variant='contained' sx={{ width: "100%", marginTop: "20px" }}>Sign Up</Button>
